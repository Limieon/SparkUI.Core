...
export const EModelFileFormat = pgEnum('EFileFormat', [
    'SafeTensors',
    'PickleTensor',
    'ONNX',
    'Other',
...
export const EGenerationStatus = pgEnum('EGenerationStatus', [
    'Pending',
    'Running',
    'Succeded',
    'Failed',
...
export const EControlNetMode = pgEnum('EControlNetMode', [
    'Balanced',
    'Prompt',
    'ControlNet',
])
export const EControlNetResizeMode = pgEnum('EControlNetResizeMode', [
    'Resize',
    'CropAndResize',
    'ResizeAndFill',
])
export const ESDTrainingType = pgEnum('ESDTrainingType', [
    'CheckpointTrained',
    'CheckpointMered',
    'Unknown',
])
export const EDownloadStatus = pgEnum('EDownloadStatus', [
    'Pending',
    'Downloading',
    'Done',
    'Failed',
...
export const SDDownloadQueueRelations = relations(
    SDDownloadQueueItem,
    ({ one }) => ({
        creator: one(User, {
...
export const SDTrainingInfo_TrainedRelations = relations(
    SDTrainingInfo_Trained,
    ({ one }) => ({
        item: one(SDBaseItem, {
...
export const SDTrainingInfo_MergedRelations = relations(
    SDTrainingInfo_Merged,
    ({ one, many }) => ({
...
export const SDCheckpointItemRelations = relations(
    SDCheckpointItem,
    ({ one, many }) => ({
        item: one(SDBaseItem, {
...
export const SDEmbeddingItemRelations = relations(
    SDEmbeddingItem,
    ({ one }) => ({
        item: one(SDBaseItem, {
...
export const SDControlNetItemRelations = relations(
    SDControlNetItem,
    ({ one }) => ({
        item: one(SDBaseItem, {
...
export const SDControlNetPreProcessorItem = pgTable(
    'SDControlNetPreProcessorItem',
    {
        id,
...
export const SDControlNetPreProcessorItemRelations = relations(
    SDControlNetPreProcessorItem,
    ({ one }) => ({
        item: one(SDBaseItem, {
...
export const SDGenerationBatch = pgTable('SDGenerationBatch', {
    ...
    // Foreign keys
    usedCheckpointId: uuid('used_checkpoint_id').references(
        () => SDCheckpointItem.id
    ),
    usedRefinerId: uuid('used_refiner_id').references(
        () => SDCheckpointItem.id
    ),
    creatorId: uuid('creator_id')
        .references(() => User.id)
...
export const SDGenerationBatchRelations = relations(
    SDGenerationBatch,
    ({ one, many }) => ({
...
export const SDGenerationBatchItemRelations = relations(
    SDGenerationBatchItem,
    ({ one }) => ({
...
export const SDGenerationBatchItemAnalysis = pgTable(
    'SDGenerationBatchItemAnalysis',
    {
        id,
...
export const SDGenerationBatchItemAnalysisRelations = relations(
    SDGenerationBatchItemAnalysis,
    ({ one }) => ({
...
export const SDatasetItemRelations = relations(
    SDDatasetItem,
    ({ one, many }) => ({
        image: one(Image, {
...
export const JSDGenerationBatchSDBaseItem = pgTable(
    'JSDGenerationBatchSDBaseItem',
    {
        weight: float64('weight').notNull(),
...
export const JSDGenerationBatchSDBaseItemRelations = relations(
    JSDGenerationBatchSDBaseItem,
    ({ one }) => ({
        batch: one(SDGenerationBatch, {
...
export const JSDGenerationBatchControlNetItem = pgTable(
    'JSDGenerationBatchControlNet',
    {
        type: EControlNetType('type').notNull(),
        pixelPerfect: boolean('pixel_perfect').notNull(),

        // Preprocessor Meta
        preprocessorId: uuid('preprocessor_id').references(
            () => SDControlNetPreProcessorItem.id
        ),
...
export const JSDGenerationBatchControlNetItemRelations = relations(
    JSDGenerationBatchControlNetItem,
    ({ one }) => ({
        batch: one(SDGenerationBatch, {
