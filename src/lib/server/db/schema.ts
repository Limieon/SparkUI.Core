...
export const SDBaseItem = pgTable('SDBaseItem', {
	...
	type: ESDItemType('type'),
	name: varchar('name', { length: 256 }),
	description: text('description'),
	brief: varchar('brief', { length: 256 }),
	version: varchar('version', { length: 64 }),
	usedInBatches: int32('used_in_batches').default(0),
	usedInImages: int32('used_in_images').default(0),
...
export const SDCheckpointItemRelations = relations(SDCheckpointItem, ({ one, many }) => ({
	...
	generationBatches_checkpoint: many(SDGenerationBatch, { relationName: 'usedCheckpoint' }),
	generationBatches_refiner: many(SDGenerationBatch, { relationName: 'usedRefiner' })
}));
